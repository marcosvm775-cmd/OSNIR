      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border-2 border-slate-300 space-y-3">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b-2 border-slate-200 pb-3">
          <div className="flex items-center space-x-2.5">
            <div className="w-9 h-9 rounded-xl bg-emerald-100 text-emerald-800 flex items-center justify-center font-bold border-2 border-emerald-300">
          ...
          <div className="flex items-center gap-1.5 bg-slate-50 p-1 rounded-xl border-2 border-slate-300">
            <button
              onClick={() => changeDateByDays(-1)}
              title="Dia anterior"
              className="p-1.5 text-slate-600 hover:text-slate-900 hover:bg-slate-200/70 rounded-lg transition cursor-pointer"
            >
            ...
            <input
              ...
              className="bg-transparent text-xs font-semibold text-slate-800 px-1 py-1 focus:outline-hidden cursor-pointer"
            />
            ...
            <button
              ...
              className="px-2 py-1 bg-white hover:bg-slate-100 text-[11px] font-bold text-emerald-800 rounded-lg border-2 border-slate-300 shadow-2xs transition cursor-pointer"
            >
              Hoje
            </button>
          </div>
          ...
          {dailyViewMode === 'list' ? (
            ...
            <div className="space-y-2">
              {filteredDailyPassengers.map((passenger, index) => (
                <div
                  key={passenger.id}
                  className="bg-white hover:bg-emerald-50/20 rounded-xl px-3 py-2 border-2 border-slate-300 hover:border-emerald-500 transition flex flex-wrap sm:flex-nowrap items-center justify-between gap-2.5 text-xs shadow-2xs hover:shadow-xs"
                >
                  {/* # + Client Name */}
                  <div className="flex items-center space-x-2.5 min-w-[170px] max-w-xs flex-1">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0 bg-emerald-50/50 border-2 border-emerald-300/80 px-2.5 py-1 rounded-lg text-[11px] shadow-2xs">
                    ...
                    <span className="font-bold text-slate-800 max-w-[105px] truncate" title={passenger.origin}>
                      {passenger.origin}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 shrink-0 bg-rose-50/50 border-2 border-rose-300/80 px-2.5 py-1 rounded-lg text-[11px] shadow-2xs">
                    ...
                    <span className="font-bold text-rose-950 max-w-[115px] truncate" title={passenger.destination}>
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-amber-50 hover:bg-amber-100 text-amber-900 border-2 border-amber-300 text-[11px] font-bold transition cursor-pointer shrink-0"
                    title="Clique para alterar o vendedor"
                  >
                    <Tag className="w-3 h-3 text-amber-700 shrink-0" />
                    <span className="max-w-[90px] truncate">VEND: {passenger.seller}</span>
                    <Edit3 className="w-2.5 h-2.5 text-amber-700 opacity-60 ml-0.5" />
                  </button>
                  ...
                  <div className="inline-flex items-center gap-1 text-[11px] shrink-0">
                    ...
                    <select
                      ...
                      className="bg-slate-50 border-2 border-slate-300 text-slate-700 text-[11px] font-semibold rounded-lg px-2 py-1 focus:ring-1 focus:ring-emerald-500 focus:outline-hidden cursor-pointer max-w-[130px] truncate"
                    >
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-rose-600 hover:bg-rose-50 border-2 border-transparent hover:border-rose-200 rounded-lg transition cursor-pointer shrink-0 ml-auto sm:ml-0"
              ...
              {selectedToPull.length > 0 && (
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-2 text-xs font-bold bg-amber-100 hover:bg-amber-200 text-amber-900 border border-amber-300 rounded-xl shadow-xs transition active:scale-95 cursor-pointer inline-flex items-center gap-1.5"
                  >
                  ...
                  >
                    ...
                    <span>Puxar {selectedToPull.length} Selecionado(s)</span>
                  </button>
                </div>
              )}
            </div>
